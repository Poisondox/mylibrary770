...
class Book(Base):
    ...
    ID = Column(Integer,primary_key=True)                   #数据库主键
    ISBN = Column(String)                                   #图书ISBN号
    book_name = Column(String,nullable=True)                #图书名称
    book_author = Column(String,nullable=True)              #图书作者
    book_publisher = Column(String,nullable=True)           #图书出版社
    book_number = Column(String,nullable=True)              #中图分类号
